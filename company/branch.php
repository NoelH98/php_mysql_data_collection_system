...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="branchFx.php">
				...
				<div class="wrap-input100 validate-input">
			       <span class="label-input100">Name of Company</span>
				...
				<div class="wrap-input100 validate-input">
			       ...
			       <input type="text" name="title" placeholder="branch name..." value="<?php echo $title; ?>">
				   <span class="focus-input100"></span>
		        </div>

				<div class="wrap-input100 validate-input">
			       <span class="label-input100">Branch description</span>

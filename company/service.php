		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="serviceFx.php">
				...
				<div class="wrap-input100 validate-input">
			       ...
			       <input type="text" name="company" placeholder="branch name..." value="<?php echo $company; ?>">
				   <span class="focus-input100"></span>
		        </div>
				<div class="wrap-input100 validate-input">
			       <span class="label-input100">Associated Branch</span>
			       <input type="text" name="title" placeholder="branch..." value="<?php echo $title; ?>">
				   <span class="focus-input100"></span>
		        </div>

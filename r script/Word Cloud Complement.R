...
text = readLines("text/complements.txt")
...
set.seed(5678)
png(filename = "images/cloud_complements.png",width = 500, height = 500)
...
png(filename = "images/temp_complements.png",width = 500, height = 500)

...
text = readLines("text/suggestion.txt")
...
set.seed(5678)
png(filename = "images/cloud_suggestion.png",width = 500, height = 500)
...
png(filename = "images/temp_suggestion.png",width = 500, height = 500)

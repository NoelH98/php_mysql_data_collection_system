...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="companyNotify.php">
			    <?php include('errors.php'); ?>
				<span class="contact100-form-title">
					Company Delete Notifications
				</span>
				
				<div class="wrap-input100 validate-input">
			       <span class="label-input100">Company Name</span>
			       <input type="text" name="username" placeholder="Company..." value="<?php echo $username; ?>">
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						...
						<button class="contact100-form-btn" name="delete_company">
							<span>
								Delete
